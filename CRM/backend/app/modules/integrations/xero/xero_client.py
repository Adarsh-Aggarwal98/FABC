...
To enable:
1. Set XERO_CLIENT_ID and XERO_CLIENT_SECRET in environment
2. Register the xero blueprint in your app
...
class XeroAuthClient:
    ...
    Usage:
        ...
        auth_url = auth_client.get_authorization_url(state='random_state')

        # Step 2: Handle callback and exchange code for tokens
        tokens = auth_client.exchange_code_for_tokens(code)
...
class XeroAPIClient:
    ...
    Usage:
        api_client = XeroAPIClient(access_token, tenant_id)

        # Get contacts
        contacts = api_client.get_contacts()

        # Create invoice
        invoice = api_client.create_invoice(invoice_data)
    """
    ...
    def get_contacts(self, page: int = 1, modified_after: datetime = None) -> Optional[Dict]:
        ...
        Args:
            ...
            modified_after: Only get contacts modified after this date
            ...
            contact_data: Contact details
                {
                    ...
                    "Phones": [{"PhoneType": "DEFAULT", "PhoneNumber": "123456"}],
    ...
    def get_invoices(self, page: int = 1, status: str = None, modified_after: datetime = None) -> Optional[Dict]:
        ...
        Args:
            ...
            modified_after: Only get invoices modified after this date
        """
        params = {'page': page}
        if status:
            ...
            payment_data: Payment details
                {
                    ...
                    "Account": {"AccountID": "xxx"},  # Bank account
                    "Amount": 100.00,
                    "Date": "2024-01-15",
    ...
    def get_accounts(self, account_type: str = None) -> Optional[Dict]:
        ...
        Args:
            account_type: Filter by type (BANK, REVENUE, EXPENSE, etc.)
        """
        params = {}
        if account_type:
