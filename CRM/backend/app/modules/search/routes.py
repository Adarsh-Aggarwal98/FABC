"""
Search Module Routes - API endpoints (Backward Compatibility Layer)

This module maintains backward compatibility by registering routes
on the main search_bp blueprint while delegating to the clean
architecture routes in routes/search_routes.py.

For new code, import from routes.search_routes directly.
"""
import logging
